...
const NJMapConfig = {
  ...
  colombia: {
    entityDef: [
      {internalId: '08', newId: 'Caqueta'},
    ],
    data: [
      {id: 'Caqueta', value: '65700', link: '/colombia/caqueta', showLabel: '1'},
    ],
  },
  ecuador: {
    entityDef: [
      {internalId: '18', newId: 'Pastaza'},
    ],
    data: [
      {id: 'Pastaza', value: '640', link: '/ecuador/pastaza', showLabel: '1'},
    ],
  },
  nigeria: {
    entityDef: [
      {internalId: 'NG.CR', newId: 'Cross River'},
    ],
    data: [
      {id: 'Cross River', value: '5', link: '/nigeria/crossriver', showLabel: '1'},
    ],
  },
};
...
const NJMap = ({ jurisdictionType, nationName, stateName }) => {
